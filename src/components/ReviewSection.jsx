            ...
            <div class="relative">
              <div class="relative w-full h-96 lg:h-[31.25rem]">
                ...
                <div class="absolute top-0 left-0 bg-teal-800 px-6 py-8 flex items-center space-x-1 rounded-b-full">
                  ...
                  <span style={{ fontFamily: 'Recoleta-Regular, serif' }} class="text-white font-bold text-sm tracking-wide">5.0</span>
                </div>
              </div>
            </div>
            ...
            <div class="flex-1">
              <div class="bg-white p-8 max-w-lg">
                ...
                <div class="flex items-center space-x-4">
                  <button class="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-gray-600 transition-colors cursor-pointer">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                    </svg>
                  </button>
                  
                  <button class="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center text-gray-800 hover:bg-yellow-500 transition-colors border-none relative cursor-pointer">
                    <svg
