          ...
          <div class="flex flex-col lg:flex-row items-end">
            ...
            <div class="flex-1">
              <div class="bg-white p-12 rounded-lg max-w-lg">
                <h2 style={{ fontFamily: "Recoleta Bold" }} class="text-4xl lg:text-6xl font-black text-gray-800 mb-4">
                  About Us
                </h2>
                <div class="w-16 h-1 bg-teal-700 mb-6"></div>
                <p style={{ fontFamily: "VAG Rounded LT W04 Thin" }} class="text-lg text-gray-600 leading-relaxed mb-8 tracking-wide">
                ...
                <a style={{ fontFamily: "VAG Rounded LT W04 Thin" }} href="#" class="text-lg font-semibold text-gray-900 hover:text-teal-700 transition-colors duration-300 underline tracking-wider">
                  Read More
                </a>
              </div>
            </div>
