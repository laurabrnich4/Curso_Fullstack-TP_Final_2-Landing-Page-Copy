        ...
        <div class="flex flex-col md:gap-10 mb-12 max-w-6xl mx-auto pl-30">
          <div class="flex flex-col">
            <h2 class="text-5xl lg:text-6xl font-serif font-bold text-gray-800 leading-tight mb-4">Support Your <br/> Community</h2>
              ...
              <p class="text-lg text-gray-700 ">The legal definition of a charitable organization (and of charity) varies between countries and in charity law affects charitable organizations also vary.</p>
          </div>
